...
Not on Maven Central yet; build from source with [`dtrexp-java`](https://github.com/DTRExp/dtrexp-java)'s `./run.sh`. The planned coordinate is `io.onury:dtrexp`. Pure Java 17+, zero dependencies (`java.time` for IANA zones).
